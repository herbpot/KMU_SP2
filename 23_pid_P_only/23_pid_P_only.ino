...
#define _DUTY_NEU 1100 // 1500
#define _DUTY_MIN 500 // 1000

#define _SERVO_ANGLE_DIFF  151   // Replace with |D - E| degree
#define _SERVO_SPEED       30000   // servo speed 

// Target Distance
#define _DIST_TARGET    175 // Center of the rail (unit:mm)

// PID parameters
#define _KP 3    // proportional gain 3
...
float volt_to_distance(int x)
{
  ...
  return 782 -3.46*x + 5.67E-03*x*x -3.33E-06*x*x*x;
}
