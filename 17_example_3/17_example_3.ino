...
void loop()
{
  ...
  //duty = map(dist_ema, _DIST_MIN, _DIST_MAX, _DUTY_MIN, _DUTY_MAX); 12
  duty = 100 + (dist_ema-100)*12;// Put map() equivalent code here
