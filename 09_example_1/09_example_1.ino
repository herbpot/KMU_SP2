...
float dist_ema[5] = {_DIST_MIN,_DIST_MIN,_DIST_MIN,_DIST_MIN,_DIST_MIN};                     // EMA distance
int dist_num = 0;
...
void loop() {
  ...
  if (abs(dist_raw - dist_prev) > 50) {
      dist_raw = dist_prev;
  } else if ((dist_raw == 0.0) || (dist_raw > _DIST_MAX)) {
...
//  dist_ema = _EMA_ALPHA * dist_raw + (1-_EMA_ALPHA) * dist_ema;
  ...
  Serial.print(",ema:");  Serial.print((dist_ema[0] + dist_ema[1] + dist_ema[2] + dist_ema[3] + dist_ema[4])/5);
